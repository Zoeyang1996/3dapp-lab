	...
	xmlHttp.onreadystatechange = function() {
		if(xmlHttp.readyState == 4) {
			...
			for (var i=0;i<response.length;i++) {
				...
				htmlCode += '<a href="gallery/images' + response[i] +' " ' + ' data-fancybox data-caption="My X3D model render" > ';
				htmlCode += '<img class="card-img-top img-thumbnail" src="gallery/images' + response[i] + '"/>';
				htmlCode += '</a>';		
			}
