...
$(document).ready(function(){
	 ...
	 $.getJSON('./model/data.json', function(jsonObj) {
		...
		$('#x3dTitle_coke').html('<h2>' + jsonObj.pageTextData[4].x3dModelTitle + '<h2>');
		...
		$('#x3dTitle_sprite').html('<h2>' + jsonObj.pageTextData[5].x3dModelTitle + '<h2>');
		...
		$('#x3dTitle_pepper').html('<h2>' + jsonObj.pageTextData[6].x3dModelTitle + '<h2>');
